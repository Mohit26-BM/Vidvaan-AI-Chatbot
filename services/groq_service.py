...
_BASE_SYSTEM_CONTENT = (
    ...
    "When you use web_search results: ALWAYS state the actual answer, number, or fact directly "
    "and prominently — never just list sources without giving the information. "
    "For example, if asked for an exchange rate, say '1 USD = 84.5 INR' first, then elaborate. "
    "After answering, end with a **Sources** section listing used sources as markdown links: [Title](url).\n\n"
